          ...
          <div className="row">
            <div className="col-12">
              ...
              <Breadcrumb>
                ...
                <Breadcrumb.Item to={PATH.StoreLocator}>
                  Store Locator
                </Breadcrumb.Item>
              </Breadcrumb>
            </div>
              ...
              >
                <div className="card-body">
                  ...
                  <p>
                    ...
                    <a className="text-gray-500" href="tel:0987654321">
                      0987654321
                    </a>
                  </p>
                  <p className="mb-0">
                ...
                <div className="card-body border-top">
                  ...
                  <p>
                    <strong>Phone:</strong> <br />
                    <a className="text-gray-500" href="tel:0123456789">
                      0123456789
                    </a>
                  </p>
                  <p className="mb-0">
                ...
                <div className="card-body border-top">
                  ...
                  <p>
                    <strong>Phone:</strong> <br />
                    <a className="text-gray-500" href="tel:099887766554">
                      099887766554
                    </a>
                  </p>
                  <p className="mb-0">
