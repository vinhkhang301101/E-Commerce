          ...
          <div className="row">
            <div className="col-12">
              ...
              <Breadcrumb>
                ...
                <Breadcrumb.Item to={PATH.Blog}>Blog</Breadcrumb.Item>
              </Breadcrumb>
            </div>
          </div>
        </div>
              ...
              <div className="card mb-7">
                ...
                <div className="card-body px-0">
                  ...
                  <p className="mb-0 text-gray-500">
                    ...
                    You're itself may yielding green was fly one kind fish hath
                    be be winged.
                  </p>
                  {/* Button */}
                  <Link
            ...
            <div className="col-12 col-md-6">
              ...
              <div className="card mb-7">
                ...
                <div className="card-body px-0">
                  ...
                  {/* Text */}
                  <p className="mb-0 text-gray-500">
                    Stars female night fowl our second in great can't after he
                    sea thing so a said two. Fowl may open first.
                  </p>
                  {/* Button */}
                  <Link
                    className="btn btn-link stretched-link px-0 text-reset"
