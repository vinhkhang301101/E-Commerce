          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10 font-size-lg text-gray-500">
              ...
              <p>
                ...
                darkness two land of creepeth there second fruitful, waters.
                Make don't void years Gathering gathering divide fill.
              </p>
              {/* Heading */}
              ...
              <p>
                * Second years heaven open dry. After let you're that, sea
                you're days over his.
              </p>
              <p>
                ** Every face divided brought. Light and greater likeness beast
              ...
              <p>
                *** Subdue called our in image. Third days they're our his Of it
              ...
              {/* Heading */}
              <h6 className="mt-8 mb-5 text-body">
                About International Shipping
              </h6>
              <p>
                Fruit heaven image us, dominion yielding heaven. There. Heaven
                Created shall Were. Sixth herb there fruit divide all she'd kind
                one moving morning, is that fruit cattle sea was. Above face
                life created moveth fill.
              </p>
              {/* Heading */}
              <h6 className="mt-8 mb-5 text-body">
              ...
              <p>
                Seas moveth Our every you'll, may i. Created created, divide
                won't fish stars from whose given creeping male. Saying him Kind
                fruitful midst rule saw behold also gathering wherein cattle
                saying it. You'll Saying years all third Darkness multiply
                wherein above said you.{" "}
                <strong className="text-body">
                  Darkness said. Good had saying lesser
                </strong>
                .
              </p>
              <p>
              ...
              <p>
                Life years called light multiply saying green. Saw Years brought
              ...
              <ol>
                <li>
                  Which all morning called of second sea wherein which you hath.
                  Forth living fourth.
                </li>
                <li>
                  Years abundantly won't said You you'll winged shall for Air
                  saw so him was moving had make fruitful unto heaven appear.
                  Won't, creepeth great. Man itself gathering she'd signs, may
                  his.
                </li>
                <li>
                  Face divided. Image subdue great can't moving waters earth
                  said rule bring above gathering.
                </li>
                <li>
                  Us for were creepeth male creeping was over creature behold
                ...
                <li>
                  Kind herb, a you'll the beginning from green that us isn't
                  there rule green.
                </li>
              </ol>
              {/* Heading */}
              ...
              <ol>
                <li>
                  After fourth very third subdue behold second forth made hath
                  place, the stars every bring.
                </li>
                <li>
                  Saying, them replenish, likeness seed grass sixth grass.
                  Creeping face. Made meat lights which Fourth. May first,
                  divide to it firmament after our likeness third great you're
                  earth there above.
                </li>
                <li>
                  Cattle multiply said, void gathered winged given make herb
                  first years.
                </li>
              </ol>
              {/* Buttons */}
